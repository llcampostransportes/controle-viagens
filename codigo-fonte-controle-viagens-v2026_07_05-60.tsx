...
const APP_VERSION = "2026.07.05-60";
...
function BoletosView({
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 8, padding: 14, width: 280, flexShrink: 0, position: "sticky", top: 20 }}>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  <thead>
                    <tr style={{ background: "#EEF0F2" }}>
                      {["Cavalo/Carreta", "Viagens", "Receita", "Comissão", "Abastec.", "Gastos", "Desp. Veíc.", "Líquido"].map((h) => (
