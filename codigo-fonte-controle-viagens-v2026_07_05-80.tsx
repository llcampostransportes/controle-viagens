...
const APP_VERSION = "2026.07.05-80";
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginBottom: 20 }}>
        ...
        <button
          onClick={openNew}
          style={{ background: "#D9A419", color: "#1B2430", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}
        >
          + Lançar boleto
        </button>
      </div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "flex-end", marginBottom: 16, flexWrap: "wrap" }}>
              ...
              <button onClick={() => window.print()} style={{ background: "#2451A6", color: "#fff", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
                Baixar PDF
              </button>
            </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ background: "#fff", padding: "18px 28px", position: "sticky", top: 0, zIndex: 10, borderBottom: "1px solid #E4E7EB", boxShadow: "0 1px 3px rgba(27,36,48,0.04)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ background: "#F7F8FA", border: "1px solid #E4E7EB", borderRadius: 12, padding: "6px 10px", display: "flex", alignItems: "center" }}>
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "24px 28px" }}>
        ...
        {/* stats */}
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 24 }}>
          <div style={{ flex: "0 0 140px" }}><MileSign label="Viagens" value={stats.count} tone="amber" full /></div>
          <div style={{ flex: "1 1 0", minWidth: 200 }}><MileSign label="A receber" value={BRL(stats.totalReceber)} tone="red" onClick={() => setStatsDetailOpen("receber")} full /></div>
        ...
        <div style={{ padding: "24px 28px", maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ background: "#EEF0FF", border: "1px solid #C7CFFA", borderRadius: 12, padding: 16, marginBottom: 20 }}>
            ...
            <textarea
              ...
              style={{ width: "100%", minHeight: 100, borderRadius: 10, border: "1px solid #C7CFFA", padding: 10, fontSize: 12, fontFamily: "'JetBrains Mono', monospace", boxSizing: "border-box" }}
            />
            <button
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "flex-end", marginBottom: 16, flexWrap: "wrap" }}>
            ...
            <button onClick={startAddSemParar} style={{ background: "#D9A419", color: "#1B2430", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
              + Lançar vencimento
            </button>
      ...
      {view === "seguro" && (
        <div style={{ padding: "24px 28px", maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "flex-end", marginBottom: 20, flexWrap: "wrap" }}>
            ...
            <button onClick={startAddSeguro} style={{ background: "#D9A419", color: "#1B2430", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
              + Lançar seguro
            </button>
        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ border: "1px dashed #B7BFC8", background: "transparent", borderRadius: 10, padding: "6px 12px", fontSize: 12, color: "#5A6472", cursor: "pointer", marginBottom: 16 }}
            >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
              {trucksCavalos.map((tr) => (
                <div key={tr.id} style={{ display: "flex", gap: 10, alignItems: "center", background: "#F7F8F9", borderRadius: 12, padding: 10 }}>
