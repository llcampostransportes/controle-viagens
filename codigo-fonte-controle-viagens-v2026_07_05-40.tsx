...
const APP_VERSION = "2026.07.05-40";
...
function BoletosView({
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 8, padding: 14, width: 280, flexShrink: 0, position: "sticky", top: 20, maxHeight: "calc(100vh - 40px)", overflowY: "auto" }}>
...
export default function App() {
  ...
  // lista exibida na tela de Viagens — igual a visibleTrips, só que com o filtro
  // de status (pendente/paga) e a ordenação escolhida por cima. Os cartões de
  // estatística (a receber, recebido, comissão) continuam usando visibleTrips
  // "cru", sem esse filtro extra, pra não mudar de valor só por causa da lista
  const tripsParaExibir = useMemo(() => {
    ...
    return list;
  }, [visibleTrips, tripListStatusFilter, tripListSortBy]);
