...
const APP_VERSION = "2026.07.30-283";
        ...
        <div className="nav-group" style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          {[
            ...
            >
              ...
              {["operacao", "financeiro", "frota", "relatorios"].includes(mod.id) && (
      ...
      {(() => {
        const submenus = {
          ...
          frota: [
            ...
            { id: "config-caminhoes", icone: "🚚", rotulo: "Cavalo", onClick: () => { setConfigSecaoAberta("caminhoes"); setConfigOpen(true); } },
