...
const APP_VERSION = "2026.07.30-238";
              ...
              {abastecReport.porPosto.map((grupo) => (
                <div key={grupo.posto} style={{ background: "#fff", borderRadius: 12, padding: 14 }}>
                  ...
                  <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 12 }}>
                    <div style={{ flex: "1 1 140px", background: "#FBEBE8", border: "1px solid #B0402E33", borderRadius: 10, padding: "8px 12px" }}>
                    ...
                    {grupo.litragemDiesel > 0 && (
                      <div style={{ flex: "1 1 140px", background: "#EAF2FB", border: "1px solid #2451A633", borderRadius: 10, padding: "8px 12px" }}>
