...
const APP_VERSION = "2026.07.05-37";
...
function EmpresasChecklist({ titulo, empresasList, empresas, empresasSelecionadas, onToggle, onMarcarTodas, onDesmarcarTodas, onResetPadrao }) {
  ...
  return (
    <div style={{ background: "#F7F8F9", borderRadius: 8, padding: 12, marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8, flexWrap: "wrap", gap: 8 }}>
        <span style={{ fontSize: 12, fontWeight: 700, color: "#5A6472", textTransform: "uppercase" }}>
          {titulo} ({empresasSelecionadas.length} de {empresasList.length})
        </span>
                  ...
                  return (
                    <label
                      ...
                      style={{
                        ...
                        padding: "5px 10px", borderRadius: 20, border: marcada ? "1px solid #1F6F5C" : "1px solid #D7DBE0",
                        background: marcada ? "#E9F5F1" : "#fff", color: marcada ? "#12503F" : "#5A6472",
                      }}
                    >
...
function BoletosView({
  ...
  // filtro por chip na lista principal (separado da seleção múltipla do relatório)
  ...
  const visibleBoletos = useMemo(() => {
    return report.items
      .filter((b) => {
        if (empresaFilter !== "all" && b.empresa !== empresaFilter) return false;
  ...
  }, [report.items, empresaFilter, listFilter, statusFilter, hoje]);

  // os cartõezinhos (Boletos/Pendente/Vencido/Pago) precisam bater com o que a
  // empresa/busca selecionada está mostrando — sem entrar no filtro de status,
  // já que são eles que mostram a divisão por status
  ...
  }, [report.items, empresaFilter, listFilter, hoje]);
