...
const APP_VERSION = "2026.07.05-70";
...
function BoletosView({
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-end", flexWrap: "wrap", background: "#fff", border: "1px solid #D9E4D0", borderRadius: 8, padding: 14, marginBottom: 14 }}>
        <div>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#5A6472", marginBottom: 4 }}>Empresa</div>
          <EmpresasChecklist
        ...
        <div style={{ flex: "1 1 200px" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#5A6472", marginBottom: 4 }}>&nbsp;</div>
          <input
            value={listFilter}
  ...
  return (
    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          .nav-lateral { width: 100% !important; height: auto !important; flex-direction: row !important; overflow-x: auto !important; position: static !important; padding: 8px !important; }
          .nav-lateral .nav-logo-area { display: none !important; }
          .nav-lateral .nav-item { flex-direction: column !important; white-space: nowrap; padding: 8px 10px !important; font-size: 10px !important; }
        }
      `}</style>
      ...
      <div
        ...
        style={{
          width: 220, flexShrink: 0, minHeight: "100vh", position: "sticky", top: 0, alignSelf: "flex-start",
      ...
      >
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background: view === item.id ? "#2451A6" : "transparent",
        ...
        <div style={{ height: 1, background: "#2E3742", margin: "16px 6px" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <button
            className="nav-item"
            onClick={() => setReportOpen(true)}
            style={{ display: "flex", alignItems: "center", gap: 10, textAlign: "left", padding: "10px 12px", borderRadius: 8, border: "none", background: "transparent", color: "#9AA5B1", fontWeight: 500, fontSize: 13, cursor: "pointer" }}
          >
