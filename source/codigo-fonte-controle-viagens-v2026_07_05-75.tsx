...
const APP_VERSION = "2026.07.05-75";
...
/* ---------- stat sign ---------- */
function MileSign({ label, value, tone, onClick, caption, toggle, full }) {
  const tones = {
      ...
      {aberto && (
        <div
          ...
          style={{
            ...
            background: "#fff", border: "1px solid #E4E7EB", borderRadius: 10, boxShadow: "0 12px 32px rgba(27,36,48,0.14)",
        ...
        >
          <input
            ...
            style={{ width: "100%", border: "1px solid #D7DBE0", borderRadius: 6, padding: "8px 10px", fontSize: 13, marginBottom: 10, outline: "none" }}
          />
            ...
            return (
              <div key={categoria} style={{ marginBottom: 4 }}>
                <button
                  ...
                  style={{ background: "#F7F8F9", borderRadius: 6, border: "none", padding: "6px 8px", cursor: "pointer", display: "flex", alignItems: "center", gap: 6, fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: 12, color: "#3A4351", width: "100%", textTransform: "uppercase", letterSpacing: 0.3 }}
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 1, marginTop: 4, marginBottom: 6 }}>
                    {nomesDaCategoria.map((nome) => {
                      ...
                      return (
                        <label
                          key={nome}
                          style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, cursor: "pointer", padding: "6px 8px", borderRadius: 6, color: marcada ? "#1B2430" : "#5A6472", background: marcada ? "#EEF2FA" : "transparent" }}
                        >
      ...
      {aberto && (
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <Field label="De">
              <input type="date" style={inputStyle} value={periodStart} onChange={(e) => onChangeStart(e.target.value)} />
            </Field>
            <Field label="Até">
              <input type="date" style={inputStyle} value={periodEnd} onChange={(e) => onChangeEnd(e.target.value)} />
            </Field>
          </div>
        </div>
      )}
...
function BoletosView({
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-end", flexWrap: "wrap", background: "#fff", border: "1px solid #E4E7EB", borderRadius: 8, padding: 14, marginBottom: 14 }}>
        <Field label="Empresa">
          <EmpresasChecklist
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ display: "flex", alignItems: "center", gap: 10, textAlign: "left", padding: "10px 12px", borderRadius: 8, border: "none", background: "transparent", color: "#E88C7D", fontWeight: 600, fontSize: 13, cursor: "pointer" }}
        >
          <span>🚪</span> Sair
        </button>
      </div>
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "24px 28px" }}>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "flex-end", flexWrap: "wrap", background: "#fff", border: "1px solid #E4E7EB", borderRadius: 8, padding: 14, marginBottom: 20 }}>
        ...
        {/* stats */}
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 24 }}>
          <div style={{ flex: "1 1 200px" }}><MileSign label="Viagens" value={stats.count} tone="amber" full /></div>
          <div style={{ flex: "1 1 200px" }}><MileSign label="A receber" value={BRL(stats.totalReceber)} tone="red" onClick={() => setStatsDetailOpen("receber")} full /></div>
          <div style={{ flex: "1 1 200px" }}>
          <MileSign
            label="Recebido"
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                    ...
                    {t.contrato && (
                      <div style={{ fontSize: 10, color: "#9AA5B1", fontFamily: "'JetBrains Mono', monospace" }}>
                        Ctr {t.contrato}
                      </div>
                    )}
                  </div>
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 700, fontSize: 15 }}>{tr.placa}</span>
                    {precisa && (
                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center", marginTop: 10, flexWrap: "wrap" }}>
                    {!tr.semAlertaOleo && (
                      <button
                        ...
                        style={{ fontSize: 11, background: "#2451A6", color: "#fff", border: "none", borderRadius: 6, padding: "6px 12px", cursor: "pointer", fontWeight: 600 }}
                      >
                        + lançar troca
                      </button>
                    )}
