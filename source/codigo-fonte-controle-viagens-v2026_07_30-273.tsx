...
const APP_VERSION = "2026.07.30-273";
      ...
      >
        ...
        <div className="nav-group" style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {[
            ...
            { id: "financeiropessoal", icone: "💳", rotulo: "Financeiro Pessoal" },
            { id: "multas", icone: "🚨", rotulo: "Multas" },
          ].map((item) => (
            <button
              key={item.id}
              className="nav-item"
        ...
        <div className="nav-group" style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            {relatoriosMenuAberto && (
              ...
              >
                {[
                  { icone: "📊", rotulo: "Relatório mensal", onClick: () => abrirRelatorio("mensal") },
                  { icone: "💰", rotulo: "Recebimento", onClick: () => abrirRelatorio("recebimento") },
                  { icone: "🧾", rotulo: "Gastos extras", onClick: () => abrirRelatorio("gastos") },
                  { icone: "⛽", rotulo: "Consumo (km/L)", onClick: () => abrirRelatorio("consumo") },
                  { icone: "🔧", rotulo: "Serviços por empresa", onClick: () => abrirRelatorio("servicos") },
                  { icone: "🧮", rotulo: "Relatório pro Contador", onClick: () => abrirRelatorio("contador") },
                ].map((item) => (
                  <button
                    key={item.rotulo}
      ...
      {configOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => {
                const abrindo = configSecaoAberta !== "backups";
                setConfigSecaoAberta(abrindo ? "backups" : null);
                if (abrindo && backupsAutomaticos === null) carregarListaBackupsAutomaticos();
              }}
              style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", background: "#F7F8F9", border: "none", borderRadius: 10, padding: "10px 14px", marginBottom: configSecaoAberta === "backups" ? 12 : 8, cursor: "pointer" }}
            >
              <span style={{ fontWeight: 700, fontSize: 13 }}>🛟 Backups automáticos</span>
              <span style={{ fontSize: 11, color: "#9AA5B1", transform: configSecaoAberta === "backups" ? "rotate(180deg)" : "none", transition: "transform 0.15s" }}>▾</span>
            </button>
            ...
            <button
              onClick={() => setConfigSecaoAberta(configSecaoAberta === "metaFaturamento" ? null : "metaFaturamento")}
              style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", background: "#F7F8F9", border: "none", borderRadius: 10, padding: "10px 14px", marginBottom: configSecaoAberta === "metaFaturamento" ? 12 : 8, cursor: "pointer" }}
            >
              <span style={{ fontWeight: 700, fontSize: 13 }}>🎯 Meta de faturamento mensal</span>
              <span style={{ fontSize: 11, color: "#9AA5B1", transform: configSecaoAberta === "metaFaturamento" ? "rotate(180deg)" : "none", transition: "transform 0.15s" }}>▾</span>
            </button>
            ...
            <button
              onClick={() => setConfigSecaoAberta(configSecaoAberta === "empresasPedagio" ? null : "empresasPedagio")}
              style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", background: "#F7F8F9", border: "none", borderRadius: 10, padding: "10px 14px", marginBottom: configSecaoAberta === "empresasPedagio" ? 12 : 8, cursor: "pointer" }}
            >
              <span style={{ fontWeight: 700, fontSize: 13 }}>🛣️ Empresas com pedágio obrigatório</span>
              <span style={{ fontSize: 11, color: "#9AA5B1", transform: configSecaoAberta === "empresasPedagio" ? "rotate(180deg)" : "none", transition: "transform 0.15s" }}>▾</span>
            </button>
