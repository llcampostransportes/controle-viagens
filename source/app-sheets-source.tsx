...
const APP_VERSION = "2026.07.30-287";
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ color: "#5A6472", fontSize: 13, marginTop: 4 }}>
              {new Date().toLocaleDateString("pt-BR", { weekday: "long", day: "2-digit", month: "long" })} · {trucksCavalos.length} {trucksCavalos.length === 1 ? "caminhão" : "caminhões"} na frota
              <span style={{ fontSize: 11, color: "#9AA5B1", fontVariantNumeric: "tabular-nums", marginLeft: 8 }}>
                · v{APP_VERSION}
              </span>
