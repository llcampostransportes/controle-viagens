...
const APP_VERSION = "2026.07.30-248";
  ...
  return (
    ...
    {view === "financeiropessoal" && (
      <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
        ...
        <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 10 }} />
        <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 16 }}>
          Período: {fmtDate(financeiroPeriodStart)} a {fmtDate(financeiroPeriodEnd)}
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "#1B2430" }}>
    ...
    {view === "multas" && (
      <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
        ...
        <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 10 }} />
        <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 16 }}>
          Período: {fmtDate(multaPeriodStart)} a {fmtDate(multaPeriodEnd)}
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ background: "#1B2430" }}>
    ...
    {relatorioContadorOpen && (
      <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
        ...
        <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 16 }} />
        <div style={{ fontSize: 13, color: "#5A6472", marginBottom: 16 }}>
          Mês de referência: {contadorMes} · {relatorioContador.qtdViagens} viagens · gerado em {new Date().toLocaleDateString("pt-BR")}
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <tbody>
            <tr style={{ background: "#E9F5F1" }}>
    ...
    <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
      ...
      <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 10 }} />
      <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 16 }}>
        Período: {fmtDate(gastosPeriodStart)} a {fmtDate(gastosPeriodEnd)}
        {gastosSetorFiltro !== "all" && <> · Setor: {gastosSetorFiltro}</>}
      </div>
      {relatorioGastosExtras.rows.length === 0 ? (
    ...
    <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
      ...
      <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 10 }} />
      <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 16 }}>
        Período: {fmtDate(consumoPeriodStart)} a {fmtDate(consumoPeriodEnd)}
        {consumoCaminhaoFiltro !== "all" && <> · Caminhão: {truckLabel(consumoCaminhaoFiltro)}</>}
      </div>
      {relatorioConsumo.linhas.length === 0 ? (
    ...
    <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
      ...
      <div style={{ width: 56, height: 4, background: "#2563EB", borderRadius: 2, marginBottom: 10 }} />
      <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 16 }}>
        Período: {fmtDate(servicosPeriodStart)} a {fmtDate(servicosPeriodEnd)}
        {servicosEmpresaFiltro !== "all" && <> · Empresa: {servicosEmpresaFiltro}</>}
      </div>
      {relatorioServicos.items.length === 0 ? (
