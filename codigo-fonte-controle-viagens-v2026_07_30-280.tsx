...
const APP_VERSION = "2026.07.30-280";
...
export default function App() {
  ...
  useEffect(() => {
    const modulosPorView = {
      ...
      viagens: "operacao", trocaoleo: "operacao", multas: "operacao",
      ...
      {(() => {
        const submenus = {
          ...
          frota: [
            ...
            { id: "semparar-frota", icone: "🛣️", rotulo: "Sem Parar", onClick: () => setView("semparar") },
          ],
          relatorios: [
            ...
            {configSecaoAberta === "geral" && (
              <div style={{ padding: "0 4px", marginBottom: 8 }}>
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
                  <button onClick={() => { salvarConfiguracoes(); setConfigSecaoAberta(null); }} style={{ flex: 1, background: "#1F6F5C", color: "#fff", border: "none", borderRadius: 10, padding: "10px", fontWeight: 700, cursor: "pointer" }}>
                    Salvar
                  </button>
                </div>
              </div>
