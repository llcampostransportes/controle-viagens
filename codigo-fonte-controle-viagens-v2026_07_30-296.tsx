...
const APP_VERSION = "2026.07.30-296";
...
const LOGO_WHITE_BASE64 = "data:image/png;base64,";
...
const VEICULOS_PESSOAIS_HEADER = ["id", "placa", "apelido"];
const ABASTECIMENTOS_AVULSOS_HEADER = ["id", "veiculoId", "data", "posto", "litragem", "valor", "km", "observacao"];
...
async function ensureSheetsExist(token) {
  ...
  const missing = ["Caminhoes", "Viagens", "Vales", "Boletos", "Empresas", "Fechamentos", "DespesasVeiculo", "TaxasPool", "Motoristas", "Contas", "TrocasOleo", "ServicosVeiculo", "SemParar", "Seguro", "SemPararOutros", "FinanceiroPessoal", "Multas", "VeiculosPessoais", "AbastecimentosAvulsos", "Config", "Backups"].filter((t) => !titles.includes(t));
  if (missing.length > 0) {
  ...
  await sheetsFetch(`/values/VeiculosPessoais!A1:C1?valueInputOption=RAW`, token, {
    method: "PUT",
    body: JSON.stringify({ range: "VeiculosPessoais!A1:C1", values: [VEICULOS_PESSOAIS_HEADER] }),
  });
  await sheetsFetch(`/values/AbastecimentosAvulsos!A1:H1?valueInputOption=RAW`, token, {
    method: "PUT",
    body: JSON.stringify({ range: "AbastecimentosAvulsos!A1:H1", values: [ABASTECIMENTOS_AVULSOS_HEADER] }),
  });
...
function rowToVeiculoPessoal(row) {
  return { id: row[0] || "", placa: row[1] || "", apelido: row[2] || "" };
}
function veiculoPessoalToRow(v) {
  return [v.id, v.placa, v.apelido];
}
function rowToAbastecimentoAvulso(row) {
  return { id: row[0] || "", veiculoId: row[1] || "", data: row[2] || "", posto: row[3] || "", litragem: row[4] || "", valor: row[5] || "", km: row[6] || "", observacao: row[7] || "" };
}
function abastecimentoAvulsoToRow(a) {
  return [a.id, a.veiculoId, a.data, a.posto, a.litragem, a.valor, a.km, a.observacao];
}
...
async function loadFromSheets(token) {
  ...
  const [caminhoesRes, viagensRes, valesRes, boletosRes, empresasRes, fechamentosRes, despesasVeiculoRes, taxasPoolRes, motoristasRes, contasRes, trocasOleoRes, servicosVeiculoRes, semPararRes, seguroRes, semPararOutrosRes, financeiroPessoalRes, multasRes, veiculosPessoaisRes, abastecimentosAvulsosRes, configRes] = await Promise.all([
    ...
    sheetsFetch(`/values/VeiculosPessoais!A2:C`, token),
    sheetsFetch(`/values/AbastecimentosAvulsos!A2:H`, token),
  ...
  const multas = (multasRes.values || [])
    .filter((row) => row[0])
    .map(rowToMulta);
  const veiculosPessoais = (veiculosPessoaisRes.values || [])
    .filter((row) => row[0])
    .map(rowToVeiculoPessoal);
  const abastecimentosAvulsos = (abastecimentosAvulsosRes.values || [])
    .filter((row) => row[0])
    .map(rowToAbastecimentoAvulso);
  const config = (configRes.values || [])
    .filter((row) => row[0])
    .map(rowToConfig);
  return { trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, financeiroPessoal, multas, veiculosPessoais, abastecimentosAvulsos, config };
}
...
const SHEET_DEFS = {
  ...
  veiculosPessoais: { nome: "VeiculosPessoais", header: VEICULOS_PESSOAIS_HEADER, colunas: "C", toRow: veiculoPessoalToRow },
  abastecimentosAvulsos: { nome: "AbastecimentosAvulsos", header: ABASTECIMENTOS_AVULSOS_HEADER, colunas: "H", toRow: abastecimentoAvulsoToRow },
...
// ícones simples da barra lateral — usam currentColor pra herdar a cor do
// texto (branco quando o módulo tá ativo, cinza quando não tá), sem depender
// de emoji colorido
function NavIcon({ tipo, size = 18 }) {
  ...
  switch (tipo) {
    ...
    case "operacao":
      return (
        <svg {...props}><rect x="1" y="7" width="13" height="10" rx="1" /><path d="M14 10h4l3 3v4h-7z" /><circle cx="6" cy="19" r="2" /><circle cx="17" cy="19" r="2" /></svg>
      );
    case "financeiro":
      return (
        <svg {...props}><circle cx="12" cy="12" r="9" /><path d="M12 7v10M9.5 9.5a2.5 2 0 0 1 2.5-1.5h.5a2 2 0 0 1 0 4h-1a2 2 0 0 0 0 4h.5a2.5 2 0 0 0 2.5-1.5" /></svg>
      );
    case "frota":
      return (
        <svg {...props}><rect x="1" y="9" width="10" height="8" rx="1" /><path d="M11 11h4l3 2.5V17h-7z" /><circle cx="5" cy="19" r="1.8" /><circle cx="16" cy="19" r="1.8" /></svg>
      );
    case "relatorios":
      return (
        <svg {...props}><path d="M4 20V10M10 20V4M16 20v-7M22 20H2" /></svg>
      );
    case "configuracoes":
      return (
        <svg {...props}><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.04 1.56V21a2 2 0 0 1-4 0v-.09A1.7 1.7 0 0 0 9 19.35a1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 4.65 15a1.7 1.7 0 0 0-1.56-1.04H3a2 2 0 0 1 0-4h.09A1.7 1.7 0 0 0 4.65 9a1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.7 1.7 0 0 0 9 4.65a1.7 1.7 0 0 0 1.04-1.56V3a2 2 0 0 1 4 0v.09a1.7 1.7 0 0 0 1.04 1.56 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.7 1.7 0 0 0 19.35 9a1.7 1.7 0 0 0 1.56 1.04H21a2 2 0 0 1 0 4h-.09a1.7 1.7 0 0 0-1.56 1.04z" /></svg>
      );
    default:
      return null;
  }
...
function BoletosView({
  boletos, onSave, onSaveMultiple, onDelete, onDeleteMultiple,
  ...
  // seleção múltipla, pra excluir vários boletos de uma vez (ex: lançamentos duplicados)
  ...
  return (
    <div style={{ padding: "24px 28px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginBottom: 20, flexWrap: "wrap" }}>
        <button
          onClick={() => { setModoSelecao((v) => !v); setBoletosSelecionados({}); }}
          style={{ background: modoSelecao ? "#EEF0F2" : "none", border: "1px solid #D7DBE0", color: "#5A6472", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}
        >
          {modoSelecao ? "Cancelar seleção" : "Selecionar vários"}
        </button>
        <button
      ...
      {modoSelecao && (
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10, background: "#EAF2FB", border: "1px solid #2451A655", borderRadius: 12, padding: "10px 14px", marginBottom: 16 }}>
          <div style={{ fontSize: 13, color: "#1B4E8C", fontWeight: 600 }}>
            {Object.values(boletosSelecionados).filter(Boolean).length} boleto{Object.values(boletosSelecionados).filter(Boolean).length !== 1 ? "s" : ""} selecionado{Object.values(boletosSelecionados).filter(Boolean).length !== 1 ? "s" : ""}
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            <button
              onClick={() => {
                const todosMarcados = visibleBoletos.filter((b) => b.__kind === "aberto").every((b) => boletosSelecionados[b.id]);
                const novo = {};
                if (!todosMarcados) visibleBoletos.forEach((b) => { if (b.__kind === "aberto") novo[b.id] = true; });
                setBoletosSelecionados(novo);
              }}
              style={{ background: "none", border: "1px solid #2451A6", color: "#2451A6", borderRadius: 8, padding: "6px 12px", fontSize: 12, fontWeight: 700, cursor: "pointer" }}
            >
              Marcar todos visíveis
            </button>
            <button
              onClick={() => {
                const ids = Object.entries(boletosSelecionados).filter(([, v]) => v).map(([id]) => id);
                if (ids.length === 0) return;
                if (!window.confirm(`Excluir ${ids.length} boleto${ids.length !== 1 ? "s" : ""} selecionado${ids.length !== 1 ? "s" : ""}? Essa ação não pode ser desfeita.`)) return;
                onDeleteMultiple(ids);
                setBoletosSelecionados({});
                setModoSelecao(false);
              }}
              disabled={Object.values(boletosSelecionados).filter(Boolean).length === 0}
              style={{ background: "#B0402E", color: "#fff", border: "none", borderRadius: 8, padding: "6px 14px", fontSize: 12, fontWeight: 700, cursor: Object.values(boletosSelecionados).filter(Boolean).length === 0 ? "default" : "pointer", opacity: Object.values(boletosSelecionados).filter(Boolean).length === 0 ? 0.5 : 1 }}
            >
          ...
          {visibleBoletos.map((b) => {
            ...
            return (
              <div
                ...
                onClick={() => {
                  if (modoSelecao) {
                    if (b.__kind !== "aberto") return;
                    setBoletosSelecionados((prev) => ({ ...prev, [b.id]: !prev[b.id] }));
                  } else {
                    openEdit(b);
                  }
                }}
              ...
              >
                {modoSelecao && (
                  <input
                    type="checkbox"
                    disabled={b.__kind !== "aberto"}
                    checked={!!boletosSelecionados[b.id]}
                    onChange={(e) => { e.stopPropagation(); setBoletosSelecionados((prev) => ({ ...prev, [b.id]: e.target.checked })); }}
                    onClick={(e) => e.stopPropagation()}
                    style={{ width: 18, height: 18, flexShrink: 0, opacity: b.__kind !== "aberto" ? 0.3 : 1 }}
                  />
                )}
...
export default function App() {
  ...
  useEffect(() => {
    const modulosPorView = {
      ...
      seguro: "frota", semparar: "frota",
      "relatorio-recebimento": "relatorios", "relatorio-gastos": "relatorios", "relatorio-consumo": "relatorios", "relatorio-servicos": "relatorios", "relatorio-contador": "relatorios",
    };
    if (modulosPorView[view]) setModuloAtivo(modulosPorView[view]);
    const rotulosPorView = {
      dashboard: "Viagens", dashboardGeral: "Geral", viagens: "Viagens", abastecimentos: "Abastecimentos",
      trocaoleo: "Troca de Óleo", multas: "Multas", boletos: "Contas a pagar", financeiropessoal: "Financeiro Pessoal",
      seguro: "Seguro", semparar: "Sem Parar",
      "relatorio-recebimento": "Recebimento", "relatorio-gastos": "Gastos extras", "relatorio-consumo": "Consumo (km/L)", "relatorio-servicos": "Serviços por empresa", "relatorio-contador": "Relatório pro Contador",
    };
    if (rotulosPorView[view]) {
      setAbasAbertas((prev) => (prev.some((a) => a.id === view) ? prev : [...prev, { id: view, rotulo: rotulosPorView[view] }]));
    }
  }, [view]);
  ...
  const [veiculosPessoais, setVeiculosPessoais] = useState([]);
  const [abastecimentosAvulsos, setAbastecimentosAvulsos] = useState([]);
  const [avulsoFormAberto, setAvulsoFormAberto] = useState(false);
  const [avulsoEditingId, setAvulsoEditingId] = useState(null);
  const [avulsoVeiculoId, setAvulsoVeiculoId] = useState("");
  const [avulsoData, setAvulsoData] = useState("");
  const [avulsoPosto, setAvulsoPosto] = useState("");
  const [avulsoLitragem, setAvulsoLitragem] = useState("");
  const [avulsoValor, setAvulsoValor] = useState("");
  const [avulsoKm, setAvulsoKm] = useState("");
  const [avulsoObservacao, setAvulsoObservacao] = useState("");
  ...
  // igual truckLabel, mas cobre também os itens de abastecimento avulso
  // (veículo pessoal), que não têm caminhaoId
  const veiculoOuPlacaLabel = (a) => (a.avulsoId ? `🚗 ${a.veiculoPessoalNome}` : truckLabel(a.caminhaoId));
  ...
  // abas que a pessoa já abriu (tipo aba de navegador) — só aparecem na barra
  // horizontal as que ela escolheu abrir, cada uma com um X pra fechar
  const [abasAbertas, setAbasAbertas] = useState([{ id: "viagens", rotulo: "Viagens" }]);
  // qual dropdown de módulo (Operação, Financeiro, Frota, Relatórios) está
  // aberto no momento, mostrando as opções pra escolher e abrir como aba
  const [moduloDropdownAberto, setModuloDropdownAberto] = useState(null);
  ...
  // controla o mini seletor de data que abre ao clicar em "marcar pago/recebido"
  const [marcandoPagoId, setMarcandoPagoId] = useState(null);
  const [marcandoPagoData, setMarcandoPagoData] = useState("");
  ...
  const [usuarioLogado, setUsuarioLogado] = useState(null); // { nome, email, foto }
      ...
      if (window.google && window.google.accounts && window.google.accounts.oauth2) {
        tokenClientRef.current = window.google.accounts.oauth2.initTokenClient({
          ...
          callback: async (resp) => {
            ...
            setSignedIn(true);
            setAuthError("");
            // busca nome/e-mail/foto de quem tá logado, só pra mostrar na tela —
            // se essa busca falhar por qualquer motivo, não trava o resto do app
            fetch("https://www.googleapis.com/oauth2/v2/userinfo", {
              headers: { Authorization: `Bearer ${resp.access_token}` },
            })
              .then((r) => (r.ok ? r.json() : null))
              .then((info) => {
                if (info) setUsuarioLogado({ nome: info.name || info.email || "", email: info.email || "", foto: info.picture || "" });
              })
              .catch(() => {});
  ...
  const reloadFromSheets = async () => {
    try {
      const { trucks: t, trips: v, vales: vl, boletos: bo, empresas: emp, fechamentos: fe, despesasVeiculo: dv, taxasPool: tp, motoristas: mo, contas: ct, trocasOleo: to, servicosVeiculo: sv, semParar: sp, seguro: sg, semPararOutros: spo, financeiroPessoal: fp, multas: mt, veiculosPessoais: vp, abastecimentosAvulsos: aa, config: cfg } = await loadFromSheets(tokenRef.current);
      ...
      setMultas(mt);
      setVeiculosPessoais(vp);
      setAbastecimentosAvulsos(aa);
      setConfig(cfg);
  ...
  const persist = async (nextTrucks, nextTrips, nextVales = vales, nextBoletos = boletos, nextEmpresas = empresas, nextFechamentos = fechamentos, nextDespesasVeiculo = despesasVeiculo, nextTaxasPool = taxasPool, nextMotoristas = motoristas, nextContas = contas, nextTrocasOleo = trocasOleo, nextServicosVeiculo = servicosVeiculo, nextSemParar = semParar, nextSeguro = seguro, nextSemPararOutros = semPararOutros, nextConfig = config, nextFinanceiroPessoal = financeiroPessoal, nextMultas = multas, nextVeiculosPessoais = veiculosPessoais, nextAbastecimentosAvulsos = abastecimentosAvulsos) => {
    ...
    if (nextVeiculosPessoais !== veiculosPessoais) changes.veiculosPessoais = nextVeiculosPessoais;
    if (nextAbastecimentosAvulsos !== abastecimentosAvulsos) changes.abastecimentosAvulsos = nextAbastecimentosAvulsos;
  ...
  // exclui vários boletos de uma vez (ex: lançamentos duplicados) — a confirmação
  // já acontece na tela, então aqui só executa
  const deleteBoletosMultiplos = (ids) => {
    const nextBoletos = boletos.filter((b) => !ids.includes(b.id));
    setBoletos(nextBoletos);
    persist(trucks, trips, vales, nextBoletos);
  };
  ...
  // veículos pessoais (carros que abastecem no mesmo posto da frota, mas não fazem viagem)
  const addVeiculoPessoal = (placa, apelido) => {
    const placaLimpa = placa.trim().toUpperCase();
    if (!placaLimpa) return;
    const nextLista = [...veiculosPessoais, { id: uid(), placa: placaLimpa, apelido: (apelido || "").trim() }];
    setVeiculosPessoais(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, nextLista);
  };
  const updateVeiculoPessoal = (id, dados) => {
    const nextLista = veiculosPessoais.map((v) => (v.id === id ? { ...v, ...dados } : v));
    setVeiculosPessoais(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, nextLista);
  };
  const removeVeiculoPessoal = (id) => {
    if (!window.confirm("Remover esse veículo pessoal? Os abastecimentos avulsos já lançados pra ele continuam salvos, mas ele some da lista de seleção.")) return;
    const nextLista = veiculosPessoais.filter((v) => v.id !== id);
    setVeiculosPessoais(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, nextLista);
  };

  // abastecimentos avulsos (dos veículos pessoais, fora do fluxo de viagem)
  const addAbastecimentoAvulso = (dados) => {
    const nextLista = [...abastecimentosAvulsos, { id: uid(), ...dados }];
    setAbastecimentosAvulsos(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, veiculosPessoais, nextLista);
  };
  const updateAbastecimentoAvulso = (id, dados) => {
    const nextLista = abastecimentosAvulsos.map((a) => (a.id === id ? { ...a, ...dados } : a));
    setAbastecimentosAvulsos(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, veiculosPessoais, nextLista);
  };
  const deleteAbastecimentoAvulso = (id) => {
    if (!window.confirm("Excluir esse abastecimento avulso?")) return;
    const nextLista = abastecimentosAvulsos.filter((a) => a.id !== id);
    setAbastecimentosAvulsos(nextLista);
    persist(trucks, trips, vales, boletos, empresas, fechamentos, despesasVeiculo, taxasPool, motoristas, contas, trocasOleo, servicosVeiculo, semParar, seguro, semPararOutros, config, financeiroPessoal, multas, veiculosPessoais, nextLista);
  };

  const abrirNovoAvulso = () => {
    setAvulsoEditingId(null);
    setAvulsoVeiculoId(veiculosPessoais[0]?.id || "");
    setAvulsoData(todayISO());
    setAvulsoPosto("");
    setAvulsoLitragem("");
    setAvulsoValor("");
    setAvulsoKm("");
    setAvulsoObservacao("");
    setAvulsoFormAberto(true);
  };
  const abrirEditarAvulso = (a) => {
    setAvulsoEditingId(a.id);
    setAvulsoVeiculoId(a.veiculoId);
    setAvulsoData(a.data);
    setAvulsoPosto(a.posto);
    setAvulsoLitragem(a.litragem);
    setAvulsoValor(a.valor);
    setAvulsoKm(a.km);
    setAvulsoObservacao(a.observacao);
    setAvulsoFormAberto(true);
  };
  const salvarAvulso = () => {
    if (!avulsoVeiculoId || !avulsoData || !(Number(avulsoValor) > 0)) {
      alert("Escolhe o veículo, a data e o valor antes de salvar.");
      return;
    }
    const dados = { veiculoId: avulsoVeiculoId, data: avulsoData, posto: avulsoPosto.trim(), litragem: avulsoLitragem, valor: avulsoValor, km: avulsoKm, observacao: avulsoObservacao };
    if (avulsoEditingId) updateAbastecimentoAvulso(avulsoEditingId, dados);
    else addAbastecimentoAvulso(dados);
    setAvulsoFormAberto(false);
  };
  ...
  const abastecimentosFlat = useMemo(() => {
    ...
    abastecimentosAvulsos.forEach((a) => {
      const veiculo = veiculosPessoais.find((v) => v.id === a.veiculoId);
      if (Number(a.valor) > 0 || a.litragem) {
        flat.push({
          id: a.id,
          tripId: null,
          caminhaoId: null,
          avulsoId: a.id,
          avulsoVeiculoId: a.veiculoId,
          veiculoPessoalNome: veiculo ? `${veiculo.placa}${veiculo.apelido ? ` (${veiculo.apelido})` : ""}` : "Veículo pessoal removido",
          data: a.data,
          litragem: a.litragem,
          km: a.km,
          valor: Number(a.valor) || 0,
          ...
          numeroCupom: "",
          tipo: "diesel",
          origem: "Carro pessoal",
        });
      }
    });
    return flat;
  }, [trips, abastecimentosAvulsos, veiculosPessoais]);
...
function calcularConsumoEntreAbastecimentos(itensDieselOrdenados) {
  ...
  const abastecReport = useMemo(() => {
    const filtered = abastecimentosFlat
      ...
      .filter((a) => abastecPlacaFilter === "all" || (abastecPlacaFilter.startsWith("pessoal:") ? a.avulsoVeiculoId === abastecPlacaFilter.slice(8) : a.caminhaoId === abastecPlacaFilter))
  ...
  const exportAbastecCSV = () => {
    ...
    abastecReport.items.forEach((a) => {
      ...
      lines.push([a.posto, fmtDate(a.data), veiculoOuPlacaLabel(a), a.origem, a.litragem || "", valorLitro, a.numeroCupom || "", a.valor.toFixed(2)].join(";"));
    });
  ...
  // itens de cada módulo — os que têm "id" abrem como aba na barra horizontal
  // (reaproveitando a aba se já tiver aberta); os que têm "acaoDireta" apenas
  // executam a ação (abrir um modal), sem virar aba
  const submenusModulo = {
    dashboard: [
      { id: "dashboard", rotulo: "Viagens" },
      { id: "dashboardGeral", rotulo: "Geral" },
    ],
    operacao: [
      { id: "viagens", rotulo: "Viagens" },
      { id: "abastecimentos", rotulo: "Abastecimentos" },
      { id: "trocaoleo", rotulo: "Troca de Óleo" },
      { id: "multas", rotulo: "Multas" },
    ],
    financeiro: [
      { id: "boletos", rotulo: "Contas a pagar" },
      { id: "abastecimentos", rotulo: "Abastecimentos" },
      { id: "financeiropessoal", rotulo: "Financeiro Pessoal" },
    ],
    frota: [
      { id: "seguro", rotulo: "Seguro" },
      { id: "semparar", rotulo: "Sem Parar" },
      { id: "caminhoes-modal", rotulo: "Cavalo", acaoDireta: () => { setConfigSecaoAberta("caminhoes"); setConfigOpen(true); } },
      { id: "carretas-modal", rotulo: "Carretas", acaoDireta: () => { setConfigSecaoAberta("carretas"); setConfigOpen(true); } },
    ],
    relatorios: [
      { id: "rel-mensal", rotulo: "Relatório mensal", acaoDireta: () => abrirRelatorio("mensal") },
      { id: "relatorio-recebimento", rotulo: "Recebimento" },
      { id: "relatorio-gastos", rotulo: "Gastos extras" },
      { id: "relatorio-consumo", rotulo: "Consumo (km/L)" },
      { id: "relatorio-servicos", rotulo: "Serviços por empresa" },
      { id: "relatorio-contador", rotulo: "Relatório pro Contador" },
    ],
  };
  const abrirItemSubmenu = (item) => {
    setModuloDropdownAberto(null);
    if (item.acaoDireta) { item.acaoDireta(); return; }
    setAbasAbertas((prev) => (prev.some((a) => a.id === item.id) ? prev : [...prev, { id: item.id, rotulo: item.rotulo }]));
    setView(item.id);
  };
    ...
    >
      ...
      >
        <div className="nav-logo-area" style={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 24, padding: "0 6px" }}>
          <img src={LOGO_WHITE_BASE64} alt="L.L. Campos Transportes" style={{ height: 40, display: "block" }} />
        </div>

        <div className="nav-group" style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          {[
            { id: "dashboard", rotulo: "Dashboard", temSubmenu: true },
            { id: "operacao", rotulo: "Operação", temSubmenu: true },
            { id: "financeiro", rotulo: "Financeiro", temSubmenu: true },
            { id: "frota", rotulo: "Frota", temSubmenu: true },
            { id: "relatorios", rotulo: "Relatórios", temSubmenu: true },
            { id: "configuracoes", rotulo: "Configurações", temSubmenu: false, onClick: () => { setModuloAtivo("configuracoes"); abrirConfiguracoes(); } },
          ].map((mod) => (
            <div key={mod.id} style={{ position: "relative" }}>
              <button
                className="nav-item"
                onClick={() => {
                  if (!mod.temSubmenu) { mod.onClick(); return; }
                  setModuloDropdownAberto((atual) => (atual === mod.id ? null : mod.id));
                }}
                style={{
              ...
              >
                <NavIcon tipo={mod.id} />
                <span style={{ flex: 1 }}>{mod.rotulo}</span>
                {mod.temSubmenu && (
                  <span style={{ fontSize: 14, opacity: 0.7, transform: moduloDropdownAberto === mod.id ? "rotate(90deg)" : "none", transition: "transform 0.15s" }}>›</span>
                )}
              </button>
              {moduloDropdownAberto === mod.id && (
                <div
                  className="nav-dropdown"
                  style={{ display: "flex", flexDirection: "column", gap: 2, padding: "4px 0 4px 14px", marginTop: 2 }}
                >
                  {submenusModulo[mod.id].map((item) => (
                    <button
                      key={item.id}
                      onClick={() => { abrirItemSubmenu(item); setModuloAtivo(mod.id); }}
                      className="linha-clicavel"
                      style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", textAlign: "left", padding: "8px 10px", borderRadius: 8, border: "none", background: abasAbertas.some((a) => a.id === item.id) ? "rgba(255,255,255,0.08)" : "transparent", color: abasAbertas.some((a) => a.id === item.id) ? "#fff" : "#9AA5B1", fontWeight: 500, fontSize: 13, cursor: "pointer" }}
                    >
        ...
        {usuarioLogado && (
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 12px" }}>
              {usuarioLogado.foto ? (
                <img src={usuarioLogado.foto} alt={usuarioLogado.nome} referrerPolicy="no-referrer" style={{ width: 32, height: 32, borderRadius: "50%", flexShrink: 0 }} />
              ) : (
                <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#2563EB", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 13, flexShrink: 0 }}>
                  {(usuarioLogado.nome || "?").charAt(0).toUpperCase()}
                </div>
              )}
              <div style={{ minWidth: 0 }}>
                <div style={{ color: "#fff", fontSize: 13, fontWeight: 600, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{usuarioLogado.nome}</div>
                <div style={{ color: "#9AA5B1", fontSize: 11, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{usuarioLogado.email}</div>
              </div>
            </div>
          </>
        )}
        ...
        <div style={{ marginTop: 18, padding: "0 12px", color: "#6B7684", fontSize: 12, lineHeight: 1.5 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ color: "#5A6472", fontSize: 13, marginTop: 4 }}>
              {trucksCavalos.length} {trucksCavalos.length === 1 ? "caminhão" : "caminhões"} na frota · Versão {APP_VERSION}
      ...
      {/* submenu horizontal — mostra só as abas que a pessoa já abriu */}
      {(() => {
        if (abasAbertas.length === 0) return null;
        return (
            ...
            {abasAbertas.map((aba) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px 8px 10px 14px", cursor: "pointer",
                  fontSize: 13, fontWeight: view === aba.id ? 700 : 500,
                  color: view === aba.id ? "#2451A6" : "#5A6472",
                  borderBottom: view === aba.id ? "2px solid #2451A6" : "2px solid transparent",
                }}
              >
                <span onClick={() => setView(aba.id)}>{aba.rotulo}</span>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    const restantes = abasAbertas.filter((a) => a.id !== aba.id);
                    setAbasAbertas(restantes);
                    if (view === aba.id) {
                      if (restantes.length > 0) setView(restantes[restantes.length - 1].id);
                      else { setView("dashboard"); setModuloAtivo("dashboard"); }
                    }
                  }}
                  style={{ background: "none", border: "none", cursor: "pointer", color: "#9AA5B1", fontSize: 15, padding: "0 2px", lineHeight: 1 }}
                >
                  ×
                </button>
              </div>
            ...
            {dashboardReport.rows.map((r) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: "#5A6472", marginBottom: 6 }}>
                    <span>🧑‍✈️ Comissão</span>
                    <strong style={{ color: "#1B2430" }}>{BRL(r.comissaoTotal)}</strong>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: "#5A6472", marginBottom: 6 }}>
                    <span>🧾 Gastos Extras</span>
                    <strong style={{ color: "#1B2430" }}>{BRL(r.gastosTotal)}</strong>
                  </div>
      ...
      {view === "boletos" && (
        <BoletosView
          ...
          onDeleteMultiple={deleteBoletosMultiplos}
      ...
      {view === "abastecimentos" && (
        <div style={{ maxWidth: 1300, margin: "0 auto", padding: "24px 28px" }}>
          ...
          {abastecPlacaFilter === "all" && (
            <div style={{ background: "#fff", border: "1px solid #E4E7EB", borderRadius: 14, padding: 16, marginBottom: 20 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
                <div>
                  <div style={{ fontWeight: 700, fontSize: 14 }}>🚗 Abastecimentos avulsos (carros pessoais)</div>
                  <div style={{ fontSize: 11, color: "#9AA5B1" }}>Entram somados com os da frota no relatório por posto, pra bater a nota certinho.</div>
                </div>
                {!avulsoFormAberto && (
                  veiculosPessoais.length === 0 ? (
                    <span style={{ fontSize: 12, color: "#9AA5B1" }}>Cadastre um veículo pessoal em Configurações primeiro.</span>
                  ) : (
                    <button onClick={abrirNovoAvulso} style={{ background: "#1F6F5C", color: "#fff", border: "none", borderRadius: 10, padding: "8px 14px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
                      + Lançar abastecimento avulso
                    </button>
                  )
                )}
              </div>
              ...
              {avulsoFormAberto && (
                <div style={{ marginTop: 14, background: "#F7F8F9", borderRadius: 12, padding: 14, display: "flex", gap: 10, flexWrap: "wrap", alignItems: "flex-end" }}>
                  <Field label="Veículo">
                    <select style={inputStyle} value={avulsoVeiculoId} onChange={(e) => setAvulsoVeiculoId(e.target.value)}>
                      {veiculosPessoais.map((v) => (
                        <option key={v.id} value={v.id}>{v.placa}{v.apelido ? ` — ${v.apelido}` : ""}</option>
                      ))}
                    </select>
                  </Field>
                  <Field label="Data">
                    <input type="date" style={inputStyle} value={avulsoData} onChange={(e) => setAvulsoData(e.target.value)} onBlur={(e) => setAvulsoData(corrigirAnoDigitado(e.target.value))} />
                  </Field>
                  <Field label="Posto">
                    <input list="lista-postos-avulso" style={inputStyle} value={avulsoPosto} onChange={(e) => setAvulsoPosto(e.target.value)} placeholder="Posto Miradouro" />
                    <datalist id="lista-postos-avulso">
                      {abastecPostosList.map((p) => <option key={p} value={p} />)}
                    </datalist>
                  </Field>
                  <Field label="Litros">
                    <input type="number" style={{ ...inputStyle, width: 90 }} value={avulsoLitragem} onChange={(e) => setAvulsoLitragem(e.target.value)} />
                  </Field>
                  <Field label="Valor R$">
                    <input type="number" style={{ ...inputStyle, width: 110 }} value={avulsoValor} onChange={(e) => setAvulsoValor(e.target.value)} />
                  </Field>
                  <Field label="KM (opcional)">
                    <input type="number" style={{ ...inputStyle, width: 100 }} value={avulsoKm} onChange={(e) => setAvulsoKm(e.target.value)} />
                  </Field>
                  <Field label="Observação (opcional)">
                    <input style={{ ...inputStyle, minWidth: 150 }} value={avulsoObservacao} onChange={(e) => setAvulsoObservacao(e.target.value)} />
                  </Field>
                  <button onClick={salvarAvulso} style={{ background: "#1F6F5C", color: "#fff", border: "none", borderRadius: 10, padding: "9px 16px", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
                    Salvar
                  </button>
                  <button onClick={() => setAvulsoFormAberto(false)} style={{ background: "none", border: "1px solid #D7DBE0", borderRadius: 10, padding: "9px 16px", cursor: "pointer" }}>
                    Cancelar
                  </button>
                </div>
              )}

              {abastecimentosAvulsos.length > 0 && (
                <div style={{ marginTop: 14, overflowX: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                    <thead>
                      <tr style={{ borderBottom: "2px solid #EEF0F2" }}>
                        {["Data", "Carro", "Posto", "Litragem", "R$/L", "Valor", ""].map((h, i) => (
                          <th key={h} style={{ padding: "5px 8px", textAlign: i === 5 ? "right" : "left", fontSize: 11, color: "#5A6472", fontWeight: 700, textTransform: "uppercase" }}>{h}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
                      {abastecimentosAvulsos
                        .slice()
                        .sort((a, b) => (b.data || "").localeCompare(a.data || ""))
                        .map((a) => {
                          const veiculo = veiculosPessoais.find((v) => v.id === a.veiculoId);
                          ...
                          return (
                            <tr key={a.id} style={{ borderBottom: "1px solid #EEF0F2" }}>
                              ...
                              <td style={{ padding: "5px 8px" }}>🚗 {veiculo ? `${veiculo.placa}${veiculo.apelido ? ` (${veiculo.apelido})` : ""}` : "veículo removido"}</td>
                              <td style={{ padding: "5px 8px", color: "#5A6472" }}>{a.posto || "sem posto"}</td>
                              <td style={{ padding: "5px 8px", color: "#5A6472" }}>{litros ? formatLitros(litros) : "—"}</td>
                              <td style={{ padding: "5px 8px", color: "#5A6472" }}>{litros ? BRL((Number(a.valor) || 0) / litros) : "—"}</td>
                              <td style={{ padding: "5px 8px", textAlign: "right", fontWeight: 700 }}>{BRL(Number(a.valor) || 0)}</td>
                              <td style={{ padding: "5px 8px", textAlign: "right", whiteSpace: "nowrap" }}>
                                <button onClick={() => abrirEditarAvulso(a)} style={{ background: "none", border: "none", color: "#2451A6", cursor: "pointer", fontSize: 12, marginRight: 8 }}>editar</button>
                                <button onClick={() => deleteAbastecimentoAvulso(a.id)} style={{ background: "none", border: "none", color: "#B0402E", cursor: "pointer", fontSize: 14 }}>×</button>
                              </td>
                            </tr>
                          );
                        })}
          ...
          <div style={{ display: "flex", gap: 16, alignItems: "flex-end", flexWrap: "wrap", background: "#fff", border: "1px solid #E4E7EB", borderRadius: 12, padding: 14, marginBottom: 20 }}>
            <Field label="Placa">
              <select style={inputStyle} value={abastecPlacaFilter} onChange={(e) => setAbastecPlacaFilter(e.target.value)}>
                ...
                {trucksCavalos.map((tr) => <option key={tr.id} value={tr.id}>{tr.placa}{tr.modelo ? ` — ${tr.modelo}` : ""}</option>)}
                {veiculosPessoais.length > 0 && (
                  <optgroup label="Veículos pessoais">
                    {veiculosPessoais.map((v) => <option key={`pessoal:${v.id}`} value={`pessoal:${v.id}`}>🚗 {v.placa}{v.apelido ? ` — ${v.apelido}` : ""}</option>)}
                  </optgroup>
                )}
              </select>
            </Field>
                    ...
                    <tbody>
                      {grupo.items.map((a) => (
                        <tr key={a.id} style={{ borderBottom: "1px solid #EEF0F2" }}>
                          ...
                          <td style={{ padding: "5px 8px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{veiculoOuPlacaLabel(a)}</td>
                    ...
                    return (
                      <tr key={f.id} style={{ borderTop: "1px solid #EEF0F2", background: vencido ? "#FFF6E2" : i % 2 === 0 ? "#fff" : "#F7F8F9" }}>
                        ...
                        <td style={{ padding: "8px 10px", textAlign: "right", whiteSpace: "nowrap" }}>
                          {!pago && marcandoPagoId === f.id ? (
                            <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                              <input
                                type="date"
                                value={marcandoPagoData}
                                onChange={(e) => setMarcandoPagoData(e.target.value)}
                                onBlur={(e) => setMarcandoPagoData(corrigirAnoDigitado(e.target.value))}
                                style={{ ...inputStyle, padding: "4px 6px", fontSize: 12, width: 130 }}
                              />
                              <button
                                onClick={() => { updateFinanceiroPessoal(f.id, { ...f, dataPagamento: marcandoPagoData }); setMarcandoPagoId(null); }}
                                style={{ background: "#1F6F5C", color: "#fff", border: "none", borderRadius: 6, padding: "4px 8px", cursor: "pointer", fontSize: 11, fontWeight: 700 }}
                              >
                                ✓
                              </button>
                              <button onClick={() => setMarcandoPagoId(null)} style={{ background: "none", border: "none", color: "#9AA5B1", cursor: "pointer", fontSize: 14 }}>×</button>
                            </span>
                          ) : (
                            !pago && (
                              <button
                                onClick={() => { setMarcandoPagoId(f.id); setMarcandoPagoData(todayISO()); }}
        ...
        >
          ...
          >
              ...
              <>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(190px, 1fr))", gap: 14 }}>
                  {[
                    ...
                    { chave: "senha", emoji: "🔒", cor: "#5A6472", bg: "#F7F8F9", titulo: "Senha do sistema", desc: "Ative uma senha extra pra abrir o app, além do login do Google." },
                    { chave: "alertaBoleto", emoji: "🧾", cor: "#B0402E", bg: "#FBEBE8", titulo: "Alerta de boleto vencido", desc: "Escolha quais empresas geram aviso de boleto vencido." },
                    { chave: "categoriasDashboard", emoji: "🌐", cor: "#2451A6", bg: "#EAF2FB", titulo: "Categorias no Dashboard", desc: "Escolha quais categorias de empresa entram no cálculo do Dashboard Geral." },
                    { chave: "veiculosPessoais", emoji: "🚗", cor: "#1F6F5C", bg: "#E9F5F1", titulo: "Veículos Pessoais", desc: "Cadastre carros pessoais pra lançar abastecimento avulso, sem viagem." },
                    ...
                    >
                      <div style={{ width: 32, height: 4, borderRadius: 2, background: c.cor }} />
            ...
            {configSecaoAberta === "geral" && (
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 12 }}>📊 Comissão e óleo</div>
            )}
            {configSecaoAberta === "geral" && (
            ...
            {configSecaoAberta === "senha" && (
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 12 }}>🔒 Senha do sistema</div>
            )}
            {configSecaoAberta === "senha" && (
              <div style={{ padding: "0 4px", marginBottom: 8 }}>
                <div style={{ fontSize: 11, color: "#9AA5B1", marginBottom: 10 }}>
            ...
            {/* seção: alerta de boleto vencido */}
            {configSecaoAberta === "alertaBoleto" && (
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 12 }}>🧾 Alerta de boleto vencido</div>
            )}
            {configSecaoAberta === "alertaBoleto" && (
              <div style={{ padding: "0 4px", marginBottom: 8 }}>
                <div style={{ fontSize: 11, color: "#9AA5B1", marginBottom: 10 }}>
            ...
            {/* seção: categorias de boleto no dashboard geral */}
            {configSecaoAberta === "categoriasDashboard" && (
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 12 }}>🌐 Categorias no Dashboard</div>
            )}
            {configSecaoAberta === "categoriasDashboard" && (
              <div style={{ padding: "0 4px", marginBottom: 8 }}>
                <div style={{ fontSize: 11, color: "#9AA5B1", marginBottom: 10 }}>
            ...
            {/* seção: veículos pessoais */}
            {configSecaoAberta === "veiculosPessoais" && (
              <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 12 }}>🚗 Veículos Pessoais</div>
            )}
            {configSecaoAberta === "veiculosPessoais" && (
              <div style={{ padding: "0 4px", marginBottom: 8 }}>
                <div style={{ fontSize: 12, color: "#5A6472", marginBottom: 10 }}>
                  Cadastre aqui carros pessoais (não fazem parte da frota, não têm viagem) só pra poder lançar o abastecimento deles junto com o dos caminhões — útil pra bater a nota do posto.
                </div>
                <div style={{ display: "flex", gap: 8, marginBottom: 10 }}>
                  <input id="novaPlacaPessoal" style={{ ...inputStyle, flex: 1 }} placeholder="Placa" />
                  <input id="novoApelidoPessoal" style={{ ...inputStyle, flex: 2 }} placeholder="Apelido (ex: Carro do Zé)" />
                  <button
                    onClick={() => {
                      const placaEl = document.getElementById("novaPlacaPessoal");
                      const apelidoEl = document.getElementById("novoApelidoPessoal");
                      if (placaEl.value.trim()) {
                        addVeiculoPessoal(placaEl.value, apelidoEl.value);
                        placaEl.value = "";
                        apelidoEl.value = "";
                      }
                    }}
                ...
                {veiculosPessoais.length === 0 ? (
                  <div style={{ fontSize: 12, color: "#9AA5B1" }}>Nenhum veículo pessoal cadastrado ainda.</div>
                ) : (
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    {veiculosPessoais.map((v) => (
                      <div key={v.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#F7F8F9", borderRadius: 10, padding: "8px 12px" }}>
                        <span style={{ fontSize: 13, fontWeight: 600 }}>🚗 {v.placa}{v.apelido && ` — ${v.apelido}`}</span>
                        <button onClick={() => removeVeiculoPessoal(v.id)} style={{ background: "none", border: "none", color: "#B0402E", cursor: "pointer", fontSize: 16 }}>×</button>
                      </div>
                    ))}
                  </div>
                )}
              ...
              <tbody>
                {grupo.items.map((a, i) => (
                  <tr key={a.id} style={{ background: i % 2 === 0 ? "#fff" : "#F7F8F9" }}>
                    ...
                    <td style={{ padding: "4px 8px", textAlign: "left", borderBottom: "1px solid #EEF0F2" }}>{veiculoOuPlacaLabel(a)}</td>
