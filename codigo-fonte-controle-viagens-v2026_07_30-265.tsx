...
const APP_VERSION = "2026.07.30-265";
            ...
            {report.items.length === 0 ? (
              ...
              <>
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 16 }}>
                  <div style={{ flex: "1 1 130px", border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    <div>
                      <div style={{ fontSize: 17, fontWeight: 700 }}>{report.totals.countAberto}</div>
                      <div style={{ fontSize: 9, color: "#9AA5B1", fontWeight: 700 }}>BOLETOS EM ABERTO</div>
                    </div>
                  </div>
                  <div style={{ flex: "1 1 130px", border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    <div>
                      <div style={{ fontSize: 17, fontWeight: 700, color: "#B0402E" }}>{report.totals.countVencido}</div>
                      <div style={{ fontSize: 9, color: "#9AA5B1", fontWeight: 700 }}>VENCIDOS</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#B0402E" }}>{BRL(report.totals.vencido)}</div>
                    </div>
                  </div>
                  <div style={{ flex: "1 1 130px", border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    <div>
                      <div style={{ fontSize: 17, fontWeight: 700, color: "#8A5A00" }}>{report.totals.countPendente}</div>
                      <div style={{ fontSize: 9, color: "#9AA5B1", fontWeight: 700 }}>PENDENTES</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#8A5A00" }}>{BRL(report.totals.pendente)}</div>
                    </div>
                  </div>
                  <div style={{ flex: "1 1 130px", border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
                    <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#E9F5F1", color: "#1F6F5C", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15 }}>⏱️</div>
                    <div>
                      <div style={{ fontSize: 17, fontWeight: 700, color: "#1F6F5C" }}>{report.totals.countAVencer}</div>
                      <div style={{ fontSize: 9, color: "#9AA5B1", fontWeight: 700 }}>A VENCER (7 dias)</div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#1F6F5C" }}>{BRL(report.totals.aVencer)}</div>
                    </div>
                  </div>
                  <div style={{ flex: "1 1 150px", background: "#1B2E6B", color: "#fff", borderRadius: 10, padding: "10px 14px" }}>
                    ...
                    <div style={{ fontSize: 19, fontWeight: 700 }}>{BRL(report.totals.vencido + report.totals.pendente + report.totals.aVencer)}</div>
                  </div>
                </div>
      ...
      <div className="print-only" style={{ display: "none", padding: 24, fontFamily: "'Inter', sans-serif", color: "#1B2430", fontSize: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16, breakInside: "avoid" }}>
          <div style={{ flex: 1, border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
            <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#EAF2FB", color: "#1B4E8C", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>📄</div>
            <div>
              <div style={{ fontSize: 15, fontWeight: 700 }}>{boletosReport.totals.countAberto}</div>
              <div style={{ fontSize: 8, color: "#9AA5B1", fontWeight: 700 }}>BOLETOS EM ABERTO</div>
            </div>
          </div>
          <div style={{ flex: 1, border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#B0402E" }}>{boletosReport.totals.countVencido}</div>
              <div style={{ fontSize: 8, color: "#9AA5B1", fontWeight: 700 }}>VENCIDOS</div>
              <div style={{ fontSize: 10, fontWeight: 700, color: "#B0402E" }}>{BRL(boletosReport.totals.vencido)}</div>
            </div>
          </div>
          <div style={{ flex: 1, border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
            <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#FFF6E2", color: "#8A5A00", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>⏳</div>
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#8A5A00" }}>{boletosReport.totals.countPendente}</div>
              <div style={{ fontSize: 8, color: "#9AA5B1", fontWeight: 700 }}>PENDENTES</div>
              <div style={{ fontSize: 10, fontWeight: 700, color: "#8A5A00" }}>{BRL(boletosReport.totals.pendente)}</div>
            </div>
          </div>
          <div style={{ flex: 1, border: "1px solid #E4E7EB", borderRadius: 10, padding: "10px 12px", display: "flex", gap: 8, alignItems: "center" }}>
            <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#E9F5F1", color: "#1F6F5C", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>⏱️</div>
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#1F6F5C" }}>{boletosReport.totals.countAVencer}</div>
              <div style={{ fontSize: 8, color: "#9AA5B1", fontWeight: 700 }}>A VENCER (7 dias)</div>
              <div style={{ fontSize: 10, fontWeight: 700, color: "#1F6F5C" }}>{BRL(boletosReport.totals.aVencer)}</div>
            </div>
          </div>
          <div style={{ flex: 1, background: "#1B2E6B", color: "#fff", borderRadius: 10, padding: "10px 12px" }}>
            <div style={{ fontSize: 8, opacity: 0.85, fontWeight: 700 }}>TOTAL EM ABERTO</div>
            <div style={{ fontSize: 16, fontWeight: 700 }}>{BRL(boletosReport.totals.vencido + boletosReport.totals.pendente + boletosReport.totals.aVencer)}</div>
          </div>
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, tableLayout: "fixed" }}>
          <colgroup>
