...
const APP_VERSION = "2026.07.30-284";
  ...
  return (
    ...
    >
      ...
      >
            ...
            <div key={mod.id} style={{ position: "relative" }}>
              ...
              {moduloDropdownAberto === mod.id && (
                <div
                  ...
                  style={{ position: "absolute", left: "100%", top: 0, marginLeft: 6, zIndex: 40, background: "#fff", border: "1px solid #E4E7EB", borderRadius: 12, boxShadow: "0 12px 32px rgba(27,36,48,0.14)", padding: 8, minWidth: 190 }}
                >
                  {submenusModulo[mod.id].map((item) => (
                    <button
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", textAlign: "left", padding: "9px 10px", borderRadius: 8, border: "none", background: abasAbertas.some((a) => a.id === item.id) ? "#EAF2FB" : "transparent", color: "#1B2430", fontWeight: 500, fontSize: 13, cursor: "pointer" }}
                    >
        ...
        {moduloDropdownAberto && (
          <div onClick={() => setModuloDropdownAberto(null)} style={{ position: "fixed", inset: 0, zIndex: 39 }} />
        )}
