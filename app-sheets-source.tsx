...
const APP_VERSION = "2026.07.30-294";
...
function calcularConsumoEntreAbastecimentos(itensDieselOrdenados) {
  ...
  const submenusModulo = {
    ...
    relatorios: [
      ...
      { id: "rel-recebimento", rotulo: "Recebimento", acaoDireta: () => abrirRelatorio("recebimento") },
      { id: "rel-gastos", rotulo: "Gastos extras", acaoDireta: () => abrirRelatorio("gastos") },
      { id: "rel-consumo", rotulo: "Consumo (km/L)", acaoDireta: () => abrirRelatorio("consumo") },
      { id: "rel-servicos", rotulo: "Serviços por empresa", acaoDireta: () => abrirRelatorio("servicos") },
      { id: "rel-contador", rotulo: "Relatório pro Contador", acaoDireta: () => abrirRelatorio("contador") },
    ],
  };
                ...
                <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 6 }}>
                  {abastecimentosAvulsos
                    ...
                    .map((a) => {
                      const veiculo = veiculosPessoais.find((v) => v.id === a.veiculoId);
                      return (
                        <div key={a.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 12, background: "#F7F8F9", borderRadius: 8, padding: "6px 10px", flexWrap: "wrap", gap: 6 }}>
                          <span>
                            <strong>{fmtDate(a.data)}</strong> · {veiculo ? `${veiculo.placa}${veiculo.apelido ? ` (${veiculo.apelido})` : ""}` : "veículo removido"} · {a.posto || "sem posto"} · {BRL(Number(a.valor) || 0)}
                          </span>
                          <span>
